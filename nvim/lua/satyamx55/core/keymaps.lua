...
-- window management
keymap.set("n", "<leader>sv", "<C-w>v:enew<CR>", { desc = "Split window vertically" }) -- split window vertically
keymap.set("n", "<leader>sh", "<C-w>s:enew<CR>", { desc = "Split window horizontally" }) -- split window horizontally
